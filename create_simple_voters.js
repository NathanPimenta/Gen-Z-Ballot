...
async function main() {
    console.log("🔍 Creating Simple Dummy Voters\n");

    // Get signers
    const [deployer, officer1, officer2, officer3, voter1, candidate1, voter6, voter7, voter8, voter9, voter10] = await ethers.getSigners();
    ...
    // Simple dummy voter data with proper Aadhar format
    const dummyVoters = [
        { account: voter6, name: "Alice Johnson", age: 25, constituency: 1, voterId: "VOTER_ALICE_001", aadhar: "123456789012" },
        { account: voter7, name: "Bob Smith", age: 30, constituency: 1, voterId: "VOTER_BOB_002", aadhar: "234567890123" },
        { account: voter8, name: "Carol Davis", age: 28, constituency: 2, voterId: "VOTER_CAROL_003", aadhar: "345678901234" },
        { account: voter9, name: "David Wilson", age: 35, constituency: 2, voterId: "VOTER_DAVID_004", aadhar: "456789012345" },
        { account: voter10, name: "Emma Brown", age: 22, constituency: 3, voterId: "VOTER_EMMA_005", aadhar: "567890123456" }
    ];
    ...
    for (let i = 0; i < dummyVoters.length; i++) {
        ...
        try {
            // Convert Aadhar to proper hex format (12 bytes)
            const aadharBytes = '0x' + voterData.aadhar.padStart(24, '0');
    ...
    // Get private keys from the accounts
    const privateKeys = [
        "0x47e179ec257488ca7df7c4e9b1d39cbbae4845eba3f2af9f084166d63c69671", // Account 6
        "0x8b3a350cf5c34c9194ca85829a2df0ec3153be0318b5e2d3348e872092edffba", // Account 7
        "0x92db14e403b83dfe3df233f83dfa3a0d7096f21ca9b0d6d6b8d88b2b4ec1564e", // Account 8
        "0x4c0883a69102937d6231471b5dbb6e0cdc2972cfb9f75d6d6948e0a96cd7c1c2", // Account 9
        "0xdbda1821b80551c9d65939329250298aa3472ba22feea921c0cf5d620ea67b97"  // Account 10
    ];
